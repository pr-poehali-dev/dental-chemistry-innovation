...
export const SECTIONS = [
  ...
  { id: "facts", label: "Интересные факты", icon: "Lightbulb", image: "" },
];
...
export const FACTS: Fact[] = [
  {
    id: "f1",
    emoji: "💎",
    title: "Эмаль прочнее костей",
    text: "Зубная эмаль — самая твёрдая ткань человеческого тела (твёрдость по шкале Мооса 5–6). Она прочнее костей, потому что содержит 96% минералов против 65% в костной ткани. Однако, в отличие от кости, эмаль не способна к самовосстановлению — у неё нет живых клеток.",
    color: "border-teal/30 bg-teal/5",
  },
  {
    id: "f2",
    emoji: "⚗️",
    title: "Зуб растворяется в Cola за 2 дня",
    text: "Кола и другие газированные напитки содержат фосфорную и угольную кислоты (pH ≈ 2,5). Зуб, погружённый в колу, начинает деминерализоваться уже через несколько часов. За 48 часов эмаль теряет значительную часть структуры — именно поэтому стоматологи рекомендуют пить кислые напитки через трубочку.",
    color: "border-amber/30 bg-amber/5",
  },
  {
    id: "f3",
    emoji: "🦷",
    title: "Отпечаток зубов уникален, как отпечаток пальца",
    text: "Зубная формула каждого человека абсолютно уникальна — по ней судмедэксперты идентифицируют личность. Это связано с индивидуальным химическим составом дентина, рисунком эмалевых призм и особенностями минерализации, которые формируются ещё в утробе матери.",
    color: "border-purple-500/30 bg-purple-500/5",
  },
  {
    id: "f4",
    emoji: "✨",
    title: "Перекись водорода была открыта в 1818 году",
    text: "Луи Жак Тенар открыл H₂O₂ в 1818 году, но в стоматологии её начали применять для отбеливания лишь в 1884 году. Сегодня профессиональные системы используют концентрацию 35–40%, что в 10 раз выше, чем в аптечной перекиси. Молекула H₂O₂ настолько мала, что свободно проникает сквозь эмаль в дентин за считанные минуты.",
    color: "border-teal/30 bg-teal/5",
  },
  {
    id: "f5",
    emoji: "🔬",
    title: "Титановые импланты «сливаются» с костью",
    text: "Явление оссеоинтеграции открыл шведский учёный Пер-Ингвар Бронемарк случайно в 1952 году — он не смог извлечь титановую камеру из кости кролика. Оказалось, что TiO₂-плёнка на поверхности титана химически взаимодействует с костными белками, образуя почти нерасторжимую связь.",
    color: "border-blue-500/30 bg-blue-500/5",
  },
  {
    id: "f6",
    emoji: "🌊",
    title: "Слюна — природный реминерализатор",
    text: "Слюна содержит кальций (1,2–2 ммоль/л), фосфаты и статерины — белки, предотвращающие спонтанную кристаллизацию. После каждой атаки кислот слюна буквально «латает» микроповреждения эмали, осаждая ионы Ca²⁺ и PO₄³⁻. В сутки выделяется 0,5–1,5 литра слюны, и всё это время идёт непрерывная реминерализация.",
    color: "border-green-500/30 bg-green-500/5",
  },
  {
    id: "f7",
    emoji: "🏺",
    title: "Золото в зубах используют 3000 лет",
    text: "Древние этруски ещё в 700 году до н.э. делали зубные мосты из золота. Золото остаётся идеальным стоматологическим металлом: оно химически инертно, не корродирует, биосовместимо и пластично. Современные золотые сплавы типа Au-Pt содержат 75–85% золота и служат более 30 лет.",
    color: "border-amber/30 bg-amber/5",
  },
  {
    id: "f8",
    emoji: "🧲",
    title: "Цирконий ярче белее натурального зуба",
    text: "Диоксид циркония (ZrO₂) имеет коэффициент светопреломления 2,2 — выше, чем у натуральной эмали (1,62). Поэтому белоснежные виниры из циркония светятся ярче, чем живые зубы. Стоматологи специально подбирают оттенок, чтобы реставрация не выделялась на фоне соседних зубов.",
    color: "border-orange-500/30 bg-orange-500/5",
  },
  {
    id: "f9",
    emoji: "🧬",
    title: "Фтор меняет химию зуба навсегда",
    text: "Когда фторид-ион встраивается в кристалл гидроксиапатита, образуется фторапатит — это необратимая химическая реакция. Фторапатит в 100 миллиардов раз менее растворим в кислоте, чем исходный гидроксиапатит (Ksp = 10⁻¹²⁰ против 10⁻¹¹⁷). Именно поэтому фторирование воды снизило заболеваемость кариесом на 40–60% по всему миру.",
    color: "border-pink-500/30 bg-pink-500/5",
  },
  {
    id: "f10",
    emoji: "🤖",
    title: "Самозалечивающийся пломбировочный материал уже существует",
    text: "В 2018 году учёные из Университета Иллинойса создали композитный материал с микрокапсулами, который автоматически заполняет трещины при разрушении. При появлении микротрещины шириной > 10 мкм капсулы лопаются, мономер заполняет дефект и полимеризуется за 3–5 минут. Это имитирует механизм заживления живых тканей.",
    color: "border-indigo-500/30 bg-indigo-500/5",
  },
  {
    id: "f11",
    emoji: "🧪",
    title: "Амальгама использовалась 150 лет",
    text: "С 1830-х по 2000-е годы амальгама была самым распространённым пломбировочным материалом в мире. Её главный плюс — самоуплотнение: при контакте с влагой амальгама слегка расширяется, герметизируя края полости. ВОЗ рекомендовала поэтапный отказ от амальгамы к 2030 году из-за содержания ртути.",
    color: "border-teal/30 bg-teal/5",
  },
  {
    id: "f12",
    emoji: "🌿",
    title: "Наногидроксиапатит — в японских зубных пастах с 1980-х",
    text: "Япония первой в мире одобрила наногидроксиапатит как активный кариесзащитный компонент в 1980 году. Компания Sangi Co. запатентовала технологию после того, как NASA разрабатывало этот материал для защиты зубов и костей астронавтов от потери кальция в невесомости. Сегодня такие пасты продаются по всему миру.",
    color: "border-green-500/30 bg-green-500/5",
  },
];
